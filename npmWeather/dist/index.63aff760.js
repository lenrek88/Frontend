...
async function formFinderHandler(event1, currentCityname) {
    ...
    try {
        ...
        const sunrise = ` ${(0, _dateFns.getHours)(sunriseMs)}:${(0, _dateFns.getMinutes)(sunriseMs)}`;
        const sunset = ` ${(0, _dateFns.getHours)(sunsetMs)}:${(0, _dateFns.getMinutes)(sunsetMs)}`;
        ...
        (0, _cookie.setCookie)("cityName", cityName);
    } catch  {
...
function deleteItemHandler(event1) {
    const findItem = event1.target.previousSibling.textContent;
...
window.onload = function() {
    ...
    reloadLikedItems();
    formFinderHandler(event, (0, _cookie.getCookie)("cityName"));
};

},{"date-fns":"9yHCA","./cookie":"7KFrp"}],"9yHCA":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7KFrp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9ZIyz","adjPd"], "adjPd", "parcelRequiree00b")
